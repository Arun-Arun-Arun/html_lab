...
if(isset($_REQUEST["mode"])=="save")
{
    ...
    mysqli_query($link, "insert into products values(". $_REQUEST['txt_pid'] .",'". $_REQUEST['txt_pname'] ."','". $_REQUEST["cmb_qtype"] ."','". $_REQUEST["txt_price"] ."')");
...
<html>
        ...
        <script language="javascript">
            function valid()
            {
                ...
                if(!a.test(document.frm.txt_pid.value))
                {
                    ...
                    document.frm.txt_pid.value="";document.frm.txt_pid.focus();
                    return false;
                }
            }
        </script>
    ...
    <body>
        ...
        <form name="frm" method="post" action="product.php?mode=save" onSubmit="return valid();">
